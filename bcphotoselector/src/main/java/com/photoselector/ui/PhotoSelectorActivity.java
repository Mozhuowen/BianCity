...
//								this, true)))
				new UnlimitedDiskCache(StorageUtils.getCacheDirectory(this, true)))
				// default
	...
	public boolean onCheckedChanged(PhotoModel photoModel,
		...
		Log.v("PhotoSelectorActivity info: 	", "onCheckedChanged photoModel "+ photoModel.getOriginalPath());
		if (isChecked && this.checkIfOutOfMax()) {
			Toast.makeText(
					this,
					String.format(
							getString(R.string.max_img_limit_reached),
	...
	public boolean checkIfOutOfMax() {
		return this.currentSelected >= this.MAX_IMAGE ? true: false;
	}
}
