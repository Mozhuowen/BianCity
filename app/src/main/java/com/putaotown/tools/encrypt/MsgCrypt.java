package com.putaotown.tools.encrypt;
...
//			String base64Encrypted = Base64.encodeToString(encrypted, Base64.NO_PADDING);
...
//		LogUtil.v("MsgCrypt info: ", "to encrypt data: "+content + " "+timeStamp);
		// 加密得到byte字节数组
//		String encrypt = encrypt(timeStamp, content);
