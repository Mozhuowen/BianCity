...
/**
 * 可继承ScrollView就可以滚动，继承linearlayout为固定样式
 * @author mozhuowen
 *
 */
public class PagerSlidingTabStrip extends /**HorizontalScrollView*/LinearLayout {

	public interface IconTabProvider {
		public int getPageIconResId(int position);
		public int getSelectedPageIconResId(int position);
	}
	// set if change tab offset state
	...
	private View messRedPos;	//未读消息的红点
	private ImageView messImage;		//消息图标
...
//		tabsContainer.setBackgroundResource(android.R.color.white);	//tetcode
		if (showScroll)
...
//		tabPadding = (int) TypedValue.complexToDimensionPixelSize(tabPadding, dm);
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (pager.getAdapter() instanceof IconTabProvider) {
				...
				this.iconTabProvider = (IconTabProvider) pager.getAdapter();
			} else {
	...
	private void addIconTab(final int position, int resId) {
		boolean isMessage = false;	//如果是消息图标需要添加红点
...
//		LinearLayout.LayoutParams param = new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.MATCH_PARENT, 1);
		LinearLayout.LayoutParams param = 
				new LinearLayout.LayoutParams((int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,tabWidth, getResources().getDisplayMetrics())
						, (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,tabWidth, getResources().getDisplayMetrics()));
		int padding = (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,10, getResources().getDisplayMetrics());
		
		if (isMessage) {
			FrameLayout.LayoutParams paramx = 
			...
			flayout.setTag("mess");	//标记消息图标和其他是不一样的
...
//		tab.setPadding(tabPadding, tabPadding, tabPadding, tabPadding);
	...
	/**显示未读消息红点*/
	public void showMessPos() {
		if (this.messRedPos != null)
			this.messRedPos.setVisibility(View.VISIBLE);
	}
