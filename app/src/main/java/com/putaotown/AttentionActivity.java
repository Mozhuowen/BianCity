...
public class AttentionActivity extends Activity implements OnClickListener
{
      ...
      //test code
        ...
        handler.postDelayed(new Runnable(){
			...
			public void run() {
		        ...
		        listviews.add(new ListItemPutao(context,AttentionActivity.this,new PackagePutao()).makeItemView());
		        listviews.add(new ListItemPutao(context,AttentionActivity.this,new PackagePutao()).makeItemView());
		        listviews.add(new ListItemPutao(context,AttentionActivity.this,new PackagePutao()).makeItemView());
	...
	private void initViews() {
		...
		this.listv = (ListView)findViewById(R.id.activity_attention_listv);
	}
